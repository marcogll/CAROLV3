...
async def run():
    async with async_playwright() as p:
        ...
        # 1. Splash Screen
        await page.goto(f'file://{os.getcwd()}/web/carol_platform.html')
        ...
        await page.wait_for_selector('h2:has-text("Registro de Participante")')
        ...
        await page.wait_for_selector('#inst-title:has-text("Instrucciones — Medio")')
        await page.screenshot(path='platform_instructions.png')
        print("Captured platform_instructions.png")

        # 5. Admin Dashboard
        await page.goto(f'file://{os.getcwd()}/web/admin.html')
        await page.wait_for_selector('.navbar-brand:has-text("CAROL Admin")')
